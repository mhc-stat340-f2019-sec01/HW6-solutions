...
The LASSO regression approach had the best test set MSE, with ridge regression close behind.  The linear model estimated by least squares had the worst test set MSE.
